    ...
    <nav className="fixed top-0 w-full z-40 bg-[#0B0C0E]/80 backdrop-blur-xl border-b border-[rgba(255,255,255,0.08)]" dir={dir}>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#0B0C0E] border-b border-white/5 px-4 pb-4 pt-2 space-y-2">
          <button onClick={() => handleNavigate(user ? '/home' : '/')} className="block w-full text-start py-2 text-gray-300">{t('home')}</button>
          ...
          {user ? (
            ...
            <button onClick={() => handleNavigate('/auth')} className="block w-full text-start py-2 text-[#FFD700]">{t('startJourney')}</button>
          )}
        </div>
      )}
    </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 items-center mb-16">
            <button onClick={() => navigate('/auth')} className="btn-linear-primary px-8 py-4 rounded-full text-lg min-w-[200px]">
              {t('startJourney')}
            </button>
            <button 
            ...
            <div className="relative rounded-xl border border-white/10 bg-[#141517]/50 backdrop-blur-xl overflow-hidden shadow-2xl">
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-6 opacity-80">
                ...
                <div className="col-span-1 space-y-4">
                  <div className="p-4 rounded-lg bg-white/5 border border-white/5 flex flex-col gap-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FFD700] to-orange-500" />
                      <div>
                ...
                <div className="col-span-1 md:col-span-2 space-y-4">
                  ...
                  <div className="p-6 rounded-lg bg-white/5 border border-white/5 h-64 flex flex-col justify-between">
                    ...
                    <div className="flex items-end gap-2 h-32 mt-4">
                      {[40, 70, 45, 90, 65, 85, 100].map((h, i) => (
                        <div key={i} className="flex-1 bg-gradient-to-t from-[#FFD700]/20 to-[#FFD700]/80 rounded-t-sm" style={{ height: `${h}%` }} />
                      ))}
                    </div>
                  </div>
                </div>
