      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto mb-20 border-t border-b border-white/5 py-8">
            {[
              { value: t('usersCount'), label: 'مستخدم نشط' },
              { value: t('projectsCount'), label: 'شركات ناشئة' },
              { value: '$2M+', label: 'استثمارات' },
          ...
          >
            ...
            <div className="relative rounded-xl border border-white/10 bg-[#141517]/50 backdrop-blur-xl overflow-hidden shadow-2xl group">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-[#141517]">
                ...
                <div className="mx-auto text-xs text-gray-500 font-mono group-hover:text-[#FFD700] transition-colors">تحميل لوحة التحكم</div>
              </div>
      ...
      <section className="py-20 bg-[#0B0C0E] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="linear-card p-8 rounded-3xl border-2 border-[#FFD700] relative group hover:shadow-2xl hover:shadow-[#FFD700]/10 transition-all bg-[#FFD700]/5">
              <div className="absolute -top-3 right-8 bg-[#FFD700] text-black text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                الأكثر اختياراً
              </div>
      ...
      {!loading && (
        <div className="min-h-screen flex flex-col font-sans">
          ...
          <div className="flex flex-1 pt-16 pb-16 md:pb-0">
            ...
            {/* Toggle Button for UIAuditPanel */}
            <button 
              onClick={() => setIsAuditOpen(!isAuditOpen)}
              className="fixed bottom-6 left-6 bg-[#141517] border border-white/10 p-3 rounded-full hover:bg-white/10 transition-colors z-50"
              title="Toggle UI Audit"
            >
              <Search size={24} className="text-[#FFD700]" />
            </button>
            </main>
          </div>
          ...
          <GlobalSearch isOpen={isSearchOpen} onClose={() => setIsSearchOpen(false)} />
          <CookieConsent />
          <UIAuditPanel isOpen={isAuditOpen} onClose={() => setIsAuditOpen(false)} />
        </div>
      )}
    </>
  );
