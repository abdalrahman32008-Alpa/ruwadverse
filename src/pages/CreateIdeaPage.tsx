...
import { Lightbulb, Target, Users, DollarSign, Check, ChevronLeft, ChevronRight, Wand2 } from 'lucide-react';
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="funding" className="accent-[#FFD700]" />
                      <span>نعم</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="funding" className="accent-[#FFD700]" defaultChecked />
        ...
        <div className="flex justify-between mt-8 pt-6 border-t border-white/10">
          ...
          {currentStep < STEPS.length ? (
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-[#FFD700] text-black px-8 py-2 rounded-xl font-bold hover:bg-[#FFC000] transition-colors shadow-lg shadow-[#FFD700]/20"
            >
              <Check size={20} />
              نشر المشروع
            </button>
