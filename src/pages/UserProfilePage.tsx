    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          // Mock data for demonstration since we might not have real users yet
          setProfile({
            id,
            full_name: `مستخدم ${id.substring(0, 4)}`,
            user_type: 'founder',
            bio: 'رائد أعمال شغوف ببناء منتجات تقنية تحل مشاكل حقيقية.',
            avatar_url: `https://i.pravatar.cc/150?u=${id}`,
            skills: ['إدارة المنتجات', 'التسويق', 'تطوير الأعمال'],
