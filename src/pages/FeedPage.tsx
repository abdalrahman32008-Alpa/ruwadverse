        ...
        const formattedPosts: Post[] = data.map((idea: any, index: number) => {
          ...
          return {
            ...
            author: {
              ...
              avatar_url: idea.profiles?.avatar_url || `https://i.pravatar.cc/150?u=${idea.user_id}`,
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#141517] rounded-3xl border border-white/10 overflow-hidden hover:border-white/20 transition-colors cursor-pointer group">
              <div className="aspect-[21/9] relative overflow-hidden bg-gray-800">
                <img src={`https://picsum.photos/seed/report${i}/800/400`} alt="Report cover" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" referrerPolicy="no-referrer" />
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-gray-700 overflow-hidden">
                      <img src={`https://i.pravatar.cc/150?u=author${i}`} alt="Author" className="w-full h-full object-cover" />
                    </div>
                    <div>
