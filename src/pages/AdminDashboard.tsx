  ...
  return (
    <div className="max-w-7xl mx-auto pb-20 pt-24 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          { title: 'إجمالي المستخدمين', value: loading ? '-' : stats.users.toLocaleString(), icon: Users, color: 'text-blue-400' },
          { title: 'المشاريع النشطة', value: loading ? '-' : stats.projects.toLocaleString(), icon: Activity, color: 'text-green-400' },
          { title: 'إجمالي الاستثمارات', value: loading ? '-' : `$${stats.investments.toLocaleString()}`, icon: DollarSign, color: 'text-[#FFD700]' },
          { title: 'معدل النمو', value: '0%', icon: TrendingUp, color: 'text-purple-400' },
        ].map((stat, i) => (
