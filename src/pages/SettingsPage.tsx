...
export const SettingsPage = () => {
  ...
  const groups = [
    ...
    { id: 'billing', label: 'الاشتراكات والفوترة' },
      ...
      <div className="max-w-6xl mx-auto pb-20 pt-24 px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">إدارة حسابك وتفضيلات المنصة</p>
          </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-400 mb-2">رابط LinkedIn</label>
                        <input 
                          type="url" 
                          value={linkedin}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-400 mb-2">الاهتمامات الاستثمارية (افصل بينها بفاصلة)</label>
                      <input 
                        type="text" 
                        value={investmentInterests}
                        onChange={(e) => setInvestmentInterests(e.target.value)}
                        placeholder="مثال: التقنية المالية، الذكاء الاصطناعي، التجارة الإلكترونية"
                        className="w-full bg-black/20 border border-white/10 rounded-xl p-3 text-white focus:border-[#FFD700] outline-none transition-colors" 
                      />
                    </div>
              ...
              {activeTab === 'subscription' && (
                <div className="space-y-8">
                  <div className="text-center py-8 bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-[32px] border border-white/5">
                    ...
                    <p className="text-gray-400 mb-8">أنت حالياً تستخدم الخطة المجانية.</p>
                  ...
                  <div className="pt-6 border-t border-white/10">
                    <h4 className="font-bold mb-4">تاريخ الفواتير</h4>
