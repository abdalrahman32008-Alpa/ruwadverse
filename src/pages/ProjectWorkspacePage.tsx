...
export const ProjectWorkspacePage = () => {
  const [tasks, setTasks] = useState([
    ...
    { id: 4, title: 'تطوير تدفق مصادقة المستخدم', status: 'todo' },
  ]);
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={status.id} className="linear-card p-6 rounded-3xl bg-[#141517]/80 backdrop-blur-md border border-white/10">
              <h3 className="text-lg font-bold text-white mb-4 uppercase text-xs">{status.label}</h3>
