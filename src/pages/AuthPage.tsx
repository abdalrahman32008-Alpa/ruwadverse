...
export const AuthPage = () => {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      if (error) throw error;
      toast.success('تم إعادة إرسال رمز التأكيد إلى بريدك الإلكتروني');
    } catch (err: any) {
        ...
        {mode === 'verify_otp' ? (
          <div>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              <button type="button" onClick={handleResendOtp} disabled={loading} className="w-full text-[#FFD700] hover:text-[#FFC000] text-sm transition-colors disabled:opacity-50">
