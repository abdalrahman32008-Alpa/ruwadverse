    ...
    <div className="flex flex-col lg:flex-row gap-8 relative min-h-screen">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold">أحدث المشاريع</h2>
          <span className="text-xs text-gray-500">{items.length} مشروع متاح</span>
        </div>
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-white/5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-gray-400 flex items-center gap-1">
                        {item.author.name}
                        <span className="text-[8px] bg-blue-500/10 text-blue-400 px-1 rounded">موثق</span>
                      </span>
                    </div>
