      ...
      try {
        ...
        if (data) {
            const mappedBookmarks: BookmarkItem[] = data.map((item: any) => ({
                ...
                image: `https://ui-avatars.com/api/?name=${encodeURIComponent(item.idea?.sector || 'Idea')}&background=141517&color=FFD700` // Placeholder image for now as ideas don't have images in schema yet
            }));
