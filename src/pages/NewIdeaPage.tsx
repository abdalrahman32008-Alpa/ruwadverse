            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#FFD700]/50 transition-colors"
                >
                  <option value="EdTech">{t('opt_edtech')}</option>
                  <option value="FinTech">{t('opt_fintech')}</option>
                  <option value="HealthTech">{t('opt_healthtech')}</option>
                  <option value="E-commerce">{t('opt_ecommerce')}</option>
                  <option value="AI">{t('opt_ai')}</option>
                  <option value="Logistics">{t('opt_logistics')}</option>
                  <option value="PropTech">{t('opt_proptech')}</option>
                  <option value="AgriTech">{t('opt_agritech')}</option>
                  <option value="Sustainability">{t('opt_sustainability')}</option>
                  <option value="Tourism">{t('opt_tourism')}</option>
                  <option value="Cybersecurity">{t('opt_cybersecurity')}</option>
