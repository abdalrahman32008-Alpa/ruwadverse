...
const STORIES = [
  { id: 1, user: 'أحمد', image: 'https://ui-avatars.com/api/?name=أحمد&background=141517&color=FFD700' },
  { id: 2, user: 'سارة', image: 'https://ui-avatars.com/api/?name=سارة&background=141517&color=FFD700' },
  { id: 3, user: 'خالد', image: 'https://ui-avatars.com/api/?name=خالد&background=141517&color=FFD700' },
  { id: 4, user: 'نورة', image: 'https://ui-avatars.com/api/?name=نورة&background=141517&color=FFD700' },
  { id: 5, user: 'محمد', image: 'https://ui-avatars.com/api/?name=محمد&background=141517&color=FFD700' },
];
