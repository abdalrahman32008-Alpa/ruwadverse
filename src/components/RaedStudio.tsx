...
import { MessageSquare, Mic, Image as ImageIcon, Video, FileSearch } from 'lucide-react';
...
export const RaedStudio = ({ initialMessage }: { initialMessage?: string }) => {
  const [activeTab, setActiveTab] = useState<'chat' | 'voice' | 'brand' | 'video' | 'analyze'>('chat');
