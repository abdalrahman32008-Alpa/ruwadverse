...
import { Search, Filter, Briefcase, MapPin, Code, TrendingUp, Users, Sparkles } from 'lucide-react';
...
export const ExploreSection = ({ type }: ExploreProps) => {
  ...
  // Mock Data
  const projects = [
    { id: 1, title: 'PayFast', industry: 'FinTech', location: 'Riyadh', stage: 'Seed', valuation: '5M SAR', desc: 'Seamless payments for SMEs in MENA.', skills: ['FinTech', 'Payments'] },
    { id: 2, title: 'MedConnect', industry: 'HealthTech', location: 'Dubai', stage: 'Pre-Seed', valuation: '2M SAR', desc: 'Telemedicine platform connecting patients with specialists.', skills: ['HealthTech'] },
    { id: 3, title: 'LearnAI', industry: 'EdTech', location: 'Cairo', stage: 'Series A', valuation: '15M SAR', desc: 'AI-powered personalized learning paths for students.', skills: ['EdTech', 'AI'] },
    { id: 4, title: 'ShopEasy', industry: 'E-commerce', location: 'Jeddah', stage: 'Seed', valuation: '4M SAR', desc: 'Social commerce platform for local artisans.', skills: ['E-commerce'] },
  ];

  const cofounders = [
    { id: 1, name: 'Omar H.', role: 'Tech Lead', skills: ['React', 'Node.js', 'AWS'], location: 'Remote', experience: 5, endorsements: 15, userType: 'skill' },
    { id: 2, name: 'Layla M.', role: 'Marketing', skills: ['SEO', 'Growth', 'Content'], location: 'Riyadh', experience: 3, endorsements: 8, userType: 'skill' },
    { id: 3, name: 'Youssef K.', role: 'Product', skills: ['Product Strategy', 'UX', 'Agile'], location: 'Dubai', experience: 7, endorsements: 20, userType: 'skill' },
    { id: 4, name: 'Sara A.', role: 'Sales', skills: ['B2B Sales', 'Negotiation', 'CRM'], location: 'Cairo', experience: 4, endorsements: 5, userType: 'skill' },
  ];
