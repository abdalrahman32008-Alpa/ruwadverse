  ...
  useEffect(() => {
    ...
    const fetchSectorData = async () => {
      ...
      setSectorData([
        ...
        { id: 'ai', name: 'الذكاء الاصطناعي', ideasCount: 62, investorsCount: 25, avgFunding: '150K', trend: '+45%' },
        ...
        { id: 'logistics', name: 'الخدمات اللوجستية', ideasCount: 28, investorsCount: 10, avgFunding: '80K', trend: '+18%' },
      ]);
      setLoading(false);
    };
    ...
    <div className="bg-[#141517] rounded-3xl border border-white/5 p-6 relative overflow-hidden">
      ...
      <div className="mt-6 p-4 bg-red-500/5 border border-red-500/10 rounded-2xl relative z-10">
        <h4 className="text-xs font-bold text-red-400 mb-2 flex items-center gap-1">
          <Activity size={12} /> تنبيه الفجوة السوقية (Market Gap)
        </h4>
        <p className="text-[11px] text-gray-400 leading-relaxed">
          هناك فجوة تمويلية بقيمة <span className="text-white font-bold">55 مليار دولار</span> في المنطقة بسبب نقص الفرق المتكاملة. الشركات التي تستخدم "رائد" للمطابقة الذكية تزيد فرصها في التمويل بنسبة <span className="text-green-500 font-bold">40%</span>.
        </p>
      </div>
    </div>
  );
