  ...
  const projects = [
    {
      ...
      image: 'https://ui-avatars.com/api/?name=EdTech&background=141517&color=FFD700',
      link: '#'
    },
    {
      title: 'متجر إلكتروني',
      desc: 'نظام تجارة إلكترونية متكامل مع بوابة دفع ودعم متعدد اللغات.',
      image: 'https://ui-avatars.com/api/?name=ECommerce&background=141517&color=FFD700',
      link: '#'
    }
  ];
  ...
  const recommendations = [
    {
      ...
      image: 'https://ui-avatars.com/api/?name=User1&background=141517&color=FFD700'
    },
    {
      name: 'سارة علي',
      role: 'Product Manager',
      text: 'مبدع في حل المشاكل التقنية المعقدة ودائماً يقدم حلولاً مبتكرة.',
      image: 'https://ui-avatars.com/api/?name=User2&background=141517&color=FFD700'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="absolute -top-24 right-8 flex items-end gap-6">
            <div className="relative">
              <img 
                src="https://ui-avatars.com/api/?name=Skill&background=141517&color=FFD700" 
                alt="Profile" 
