...
import { Search, Bell, MessageSquare, Menu, Globe, Crown } from 'lucide-react';
    ...
    <nav className="fixed top-0 w-full z-50 bg-[#0d1117] border-b border-white/10 h-16">
      <div className="h-full px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/pricing"
            className="hidden md:flex items-center gap-1 bg-[#FFD700]/10 text-[#FFD700] px-3 py-1.5 rounded-full text-xs font-bold hover:bg-[#FFD700]/20 transition-colors border border-[#FFD700]/20"
          >
            <Crown size={14} />
            <span>ترقية</span>
          </Link>
