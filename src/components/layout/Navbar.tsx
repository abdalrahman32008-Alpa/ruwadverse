          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-6 space-x-reverse rtl:space-x-reverse ltr:space-x-reverse">
              ...
              <div className="relative group inline-block">
                ...
                <div className="absolute top-full right-0 mt-2 w-48 bg-[#141517] border border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 py-2">
              ...
              {user && (
                <div className="relative group inline-block">
                  ...
                  <div className="absolute top-full right-0 mt-2 w-56 bg-[#141517] border border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 py-2">
