        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-[#141517] p-8 rounded-3xl border border-white/10">
              ...
              <div className="text-4xl font-bold mb-6">0 <span className="text-lg text-gray-400">{t('sar')} / {t('month')}</span></div>
            ...
            <div className="bg-gradient-to-b from-[#FFD700]/10 to-[#141517] p-8 rounded-3xl border border-[#FFD700]/30 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-[#FFD700] text-black text-xs font-bold px-3 py-1 rounded-full">POPULAR</div>
              <h3 className="text-2xl font-bold mb-2 text-[#FFD700]">{t('proPlan')}</h3>
              <div className="text-4xl font-bold mb-6">99 <span className="text-lg text-gray-400">{t('sar')} / {t('month')}</span></div>
              <ul className="space-y-4 mb-8">
