...
import { Home, Globe, ShoppingBag, Bot, MessageSquare, Bell, User, Settings, PlusCircle, LayoutDashboard } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  const menuItems = [
    { id: 'sidebar-feed', icon: Home, label: t('home'), path: '/feed' },
    { id: 'sidebar-community', icon: Globe, label: t('community'), path: '/community' },
