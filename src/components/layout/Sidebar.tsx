...
export const Sidebar = ({ isOpen }: { isOpen: boolean }) => {
  ...
  const menuItems = [
    ...
    { id: 'sidebar-project-building', icon: PlusCircle, label: t('projectBuilding'), path: '/project-building' },
    { id: 'sidebar-market-news', icon: Globe, label: t('marketPulse'), path: '/market-news' },
  ...
  return (
    <aside 
      className={`fixed start-0 top-16 h-[calc(100vh-64px)] bg-[#0d1117] border-e border-white/10 p-4 flex flex-col justify-between overflow-y-auto custom-scrollbar z-40 transition-all duration-300 ease-in-out ${
    ...
    >
      ...
      <div className="mt-8 pt-6 border-t border-white/10 space-y-4 min-w-[220px]">
