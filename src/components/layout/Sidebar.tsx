...
export const Sidebar = ({ isOpen }: { isOpen: boolean }) => {
  ...
  const menuItems = [
    ...
    { id: 'sidebar-project-building', icon: PlusCircle, label: 'بناء المشروع', path: '/project-building' },
    { id: 'sidebar-market-news', icon: Globe, label: 'نبض السوق', path: '/market-news' },
